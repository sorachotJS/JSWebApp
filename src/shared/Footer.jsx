...
function Footer() {
  return(
    ...
    <div className="container-fluid py-4 px-sm-3 px-md-5" style={{backgroundColor:"black"}}>
        <p className="m-0 text-center">&copy; <a href="#">JSFamily.com</a>. All Rights Reserved. Design by <a href="#">JS FAMILY</a></p>
    </div>
    </>
